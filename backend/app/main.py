    ...
    try:
        ...
        for c in cases:
            ...
            if existing:
                ...
                upserted_cases += 1
        db.commit()
        print(f"[seed] ✓ 同步{len(cases)}个案例（新增{upserted_cases}个）")

        # 5. 商品数据（10个，使用本地图片 /images/xxx.jpg）
        products = [
        ...
        for p in products:
            ...
            data = {**p, "merchant_id": merchant.id, "is_approved": True}
            if existing:
